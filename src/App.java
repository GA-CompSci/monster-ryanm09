...
public class App {
        ...
        while (monsterCount(0) > 0) {
            ...
            if (speedCheck <= speed) { // BONUS TURN
                ...
                if (isDefending) {
                    ...
                    if (incomingDamage < 0)
                        incomingDamage = 0; // don't go negative
    ...
    /**
     * Returns the monster from the monsters array with the lowest health
     * 
     * @return weakestMonster, null if 0 health
     */
    public static Monster getWeakestMonster() {
        // store the location of the weakest monster
